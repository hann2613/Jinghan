      ...
      <div className="contact_container container grid">
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              <i className="bx bxs-phone contact_card-icon"></i>
        ...
        <div className="contact_content">
          <h3 className="contact_title">Write your message here</h3>

          <form ref={form} onSubmit={sendEmail} className="contact_form">
            <div className="contact_form-div">
              <label className="contact_form-tag" required>Email</label>
              <input
                type="email"
                name="email"
            ...
            <div className="contact_form-div">
              <label className="contact_form-tag" required>Name</label>
              <input
                type="text"
                name="name"
                className="contact_form-input"
